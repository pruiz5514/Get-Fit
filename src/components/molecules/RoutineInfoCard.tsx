...
const RoutineInfoCard:React.FC<IRoutineInfoCardProps> = ({exerciseId, onClick}) => {
  ...
  return (
    <div className='w-full max-w-[600px] min-w-[340px] bg-darkGrey h-[80px] rounded-lg flex items-center justify-between px-4'>
        ...
        <button className="text-red-600 text-xl cursor-pointer" onClick={onClick}><RiDeleteBin5Fill /> </button>
    </div>
  )
}
