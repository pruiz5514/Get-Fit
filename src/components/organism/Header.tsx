...
export const Header: React.FC<IHeaderProps> = ({children, linkLogo}) => {
  ...
  return (
    <header className="w-full bg-darkGrey h-[85px] flex items-center justify-center fixed top-0 z-40 ">
        <nav className="max-w-[1600px] w-full px-4 flex justify-between items-center">
            <Link to={linkLogo}><h1 className="text-white text-4xl flex"> Get<span className="text-softElectricBlue flex gap-2 items-center">Fit <CgGym /></span></h1></Link>
            <div>
